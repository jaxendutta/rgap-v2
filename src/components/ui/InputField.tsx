            ...
            <div className="space-y-1">
                ...
                <div className="relative">
                    <input
                        ...
                        ref={ref}
                        className={cn(
                            "w-full px-4 rounded-2xl border py-2.5 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200",
                ...
                {error && (
                    <p className="pl-2 text-sm text-red-600 animate-in slide-in-from-top-1">
                        {error}
                    </p>
                )}
            </div>
